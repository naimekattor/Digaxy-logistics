// app/driver/approved/page.tsx
import Link from "next/link";
import { CheckCircle2, Smartphone, ArrowRight, Download } from "lucide-react";

export const metadata = {
  title: "Account Approved - Start Driving",
  description:
    "Your driver account has been approved. Download the app to start accepting delivery requests.",
};
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  To receive jobs, go online, navigate to pickup & drop-off
                  locations, and track your earnings — please download our
                  Driver App.
                </p>
              </div>
            </div>
