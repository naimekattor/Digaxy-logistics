...
const transactions = [
    { id: 'TX-1', type: 'Payout', amount: '-$450.00', date: 'Oct 28', status: 'Completed' },
    { id: 'TX-2', type: 'Move Earning', amount: '+$120.00', date: 'Oct 29', status: 'Pending' },
    { id: 'TX-3', type: 'Bonus', amount: '+$50.00', date: 'Oct 30', status: 'Completed' },
];
    ...
    <div className="max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card className="p-8 bg-brand-gold text-white shadow-xl shadow-brand-gold/20">
                ...
                <h3 className="text-5xl font-bold mb-8">$1,240.50</h3>
            ...
            <Card className="p-8 border-none shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <h3 className="text-4xl font-bold text-brand-gold">4</h3>
                    <p className="text-xs text-gray-400 mt-2 font-medium">Expected today: $320</p>
                </div>
            </Card>
        </div>
