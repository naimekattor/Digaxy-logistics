              ...
              <div className="relative" ref={profileRef}>
                ...
                <div className={cn(
                  ...
                  <div className="px-4 py-3 border-b border-gray-50 mb-2">
                    ...
                    <p className="text-sm font-bold text-gray-900 truncate">{(session.user as any)?.username || session.user?.username}</p>
                  </div>
        ...
        <div className="flex flex-col space-y-6">
          {session && (
             <div className="flex items-center gap-4 p-4 rounded-3xl bg-brand-gold/5 border border-brand-gold/10">
                ...
                <div>
                  <p className="text-xl font-bold text-gray-900">{(session.user as any)?.username || session.user?.username}</p>
